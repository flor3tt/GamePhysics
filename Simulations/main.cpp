...
void initTweakBar(){
	...
	TwType TW_TYPE_TESTCASE = TwDefineEnumFromString("Demo Scene", g_pSimulator->getTestCasesStr());
	TwAddVarRW(g_pDUC->g_pTweakBar, "Demo Scene", TW_TYPE_TESTCASE, &g_iTestCase, "");
